...
- **Purpose:** Centralize all GPT-5 interactions used for quiz generation, LaTeX QA, and handwriting transcription so the frontend and backend call a single facade.
